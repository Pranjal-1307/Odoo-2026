...
async function main() {
    ...
    const assetData = [
        { tag: 'AF-000001', name: 'Dell Latitude 5540', catId: electronics.id, deptId: itDept.id, status: client_1.AssetStatus.ALLOCATED, bookable: false, loc: 'IT Dept Floor 2' },
        { tag: 'AF-000002', name: 'MacBook Pro 16"', catId: electronics.id, deptId: itDept.id, status: client_1.AssetStatus.ALLOCATED, bookable: false, loc: 'IT Dept Floor 2' },
        { tag: 'AF-000003', name: 'HP EliteDesk 800', catId: electronics.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: false, loc: 'Storage Room A' },
        { tag: 'AF-000004', name: 'ThinkPad X1 Carbon', catId: electronics.id, deptId: itDept.id, status: client_1.AssetStatus.UNDER_MAINTENANCE, bookable: false, loc: 'IT Dept Floor 2' },
        { tag: 'AF-000005', name: 'Samsung Monitor 27"', catId: electronics.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: false, loc: 'Storage Room A' },
        { tag: 'AF-000006', name: 'Ergonomic Chair Herman Miller', catId: furniture.id, deptId: itDept.id, status: client_1.AssetStatus.ALLOCATED, bookable: false, loc: 'IT Dept Floor 2' },
        { tag: 'AF-000007', name: 'Standing Desk VariDesk', catId: furniture.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: false, loc: 'Storage Room B' },
        { tag: 'AF-000008', name: 'Toyota Innova KA-01-AB-1234', catId: vehicles.id, deptId: opsDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Parking Lot A' },
        { tag: 'AF-000009', name: 'Conference Room B2', catId: confRooms.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Floor 2, Block B' },
        { tag: 'AF-000010', name: 'Conference Room A1', catId: confRooms.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Floor 1, Block A' },
        { tag: 'AF-000011', name: 'Board Room', catId: confRooms.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Floor 3, Executive' },
        { tag: 'AF-000012', name: 'Epson Projector EB-X51', catId: officeSupplies.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'AV Storage' },
        { tag: 'AF-000013', name: 'Oscilloscope Keysight', catId: labEquip.id, deptId: itDept.id, status: client_1.AssetStatus.ALLOCATED, bookable: false, loc: 'Lab Floor 1' },
        { tag: 'AF-000014', name: 'HP LaserJet Pro', catId: officeSupplies.id, deptId: itDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Print Room Floor 2' },
        { tag: 'AF-000015', name: 'Ford EcoSport KA-01-CD-5678', catId: vehicles.id, deptId: opsDept.id, status: client_1.AssetStatus.AVAILABLE, bookable: true, loc: 'Parking Lot A' },
    ];
    const createdAssets = {};
    ...
    await prisma.booking.create({
        data: {
            ...
            status: client_1.BookingStatus.ONGOING,
        },
    });
    await prisma.booking.create({
        data: {
    ...
    await prisma.maintenanceRequest.create({
        data: {
            ...
            status: client_1.MaintenanceStatus.RESOLVED,
    ...
    const auditCycle = await prisma.auditCycle.create({
        data: {
            ...
            departmentId: itDept.id,
            status: client_1.AuditCycleStatus.IN_PROGRESS,
    ...
    await prisma.auditItem.create({
        data: {
            ...
            assetId: createdAssets['AF-000001'].id,
            auditorId: rohit.id,
            verification: client_1.AuditVerification.VERIFIED,
    ...
    await prisma.auditItem.create({
        data: {
            ...
            auditorId: rohit.id,
            verification: client_1.AuditVerification.PENDING,
        },
    });
    await prisma.auditItem.create({
        data: {
            ...
            auditorId: rohit.id,
            verification: client_1.AuditVerification.DAMAGED,
